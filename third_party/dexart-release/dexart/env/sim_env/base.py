...
class BaseSimulationEnv(object):
    ...
    def check_contact(self, actors1, actors2, impulse_threshold=1e-2) -> bool:
    ...
    def check_actor_pair_contact(self, actor1, actor2, impulse_threshold=1e-2) -> bool:
    ...
    def check_actor_pair_contacts(self, actors1, actor2,
    ...
    def check_actors_pair_contacts(self, actors1, actors2,
                                   impulse_threshold=1e-2) -> np.ndarray:
        contact_buffer = np.zeros(len(actors1))
    ...
    def check_actor_pair_contacts_in_distances(self, actors1, actor2,
    ...
    def check_actors_pair_contacts_in_distance(self, actors1, actors2,
                                               centers: List[np.ndarray], radii: List[float],
                                               impulse_threshold=1e-2, reverse=False) -> np.ndarray:
        contact_buffer = np.zeros(len(actors1))
        for actor2 in actors2:

...
class ClothShared(Cloth):
    ...
    def _sample_to_data(self, sample):
        ...
        next_rgb_right_hand = sample['next_rgb_right_hand'][:,].astype(np.float32) # (T, H, W, C) - keep original format
        next_rgb_left_hand = sample['next_rgb_left_hand'][:,].astype(np.float32) # (T, H, W, C) - keep original format
        ...
        data = {
            ...
            'next_obs': {
                ...
                'rgb_right_hand': next_rgb_right_hand, # T, H, W, C (320, 240, 3)
                'rgb_left_hand': next_rgb_left_hand, # T, H, W, C (320, 240, 3)

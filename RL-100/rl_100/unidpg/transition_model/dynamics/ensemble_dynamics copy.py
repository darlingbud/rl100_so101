...
class EnsembleDynamics(BaseDynamics):
    ...
    def step(
        ...
        terminal = self.terminal_fn(obs, action, next_obs, self.env)
        info = {}
    ...
    def obs2latent(self, batch):
        ...
        next_nobs_features = self.encoder(next_this_nobs).reshape(batch_size, -1)

        return nobs_features, next_nobs_features

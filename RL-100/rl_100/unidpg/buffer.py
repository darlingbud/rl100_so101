...
from rl_100.unidpg.utils import CONST_EPS, antmaze_timeout
from copy import deepcopy
from rl_100.unidpg.utils import RewardScaling, normalize
...
class OfflineReplayBuffer(OnlineReplayBuffer):
    ...
    def load_dataset(
        ...
        if 'antmaze' in env_name:
            print('using revise timeout')
            reward_scale = 10.; reward_bias  = -5.; is_revise_timeout = False
        if clip:
            lim = 1. - 1e-5

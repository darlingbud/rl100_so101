...
from rl_100.env.dmc.dmc_wapper import DMCEnv
...
class ActionRepeatWrapper(dm_env.Environment):
    ...
    def step(self, action):
        ...
        new_obs = OrderedDict()
        new_obs['agent_pos'] = state
        time_step = time_step._replace(observation=new_obs)
...
def make_dmc_env_2d(name, frame_stack, n_action_steps, action_repeat, seed):
    ...
    # env = DMCEnv(env,frame_skip=action_repeat,)

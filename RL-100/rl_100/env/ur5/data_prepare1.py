    ...
    if not LOAD_FROM_DATA:
        ...
        for file_name in file_names:
            ...
            for i in range(len(demo)):
                ...
                data['is_success'].append(frame['is_success'])
                data['done'].append(True if data['is_success'] else False)
        ...
        for total_id, timeout in enumerate(data['timeout']):
            if not timeout:
                ...
                point_cloud_arrays_sub.append(data['point_cloud'][total_id])
                state_arrays_sub.append(data['agent_pos'][total_id])
                action_arrays_sub.append(data['action'][total_id])
                reward_arrays_sub.append(data['reward'][total_id])
                done_arrays_sub.append(data['done'][total_id])
                timeout_arrays_sub.append(data['timeout'][total_id])
                total_count_sub += 1

                next_img_arrays_sub.append(img)
                if total_id == len(data['timeout']) - 1:
                    next_point_cloud_arrays_sub.append(data['point_cloud'][total_id])
                    next_state_arrays_sub.append(data['agent_pos'][total_id])
                    next_action_arrays_sub.append(data['action'][total_id])
                else:
                    next_point_cloud_arrays_sub.append(data['point_cloud'][total_id+1])
                    next_state_arrays_sub.append(data['agent_pos'][total_id+1])
                    next_action_arrays_sub.append(data['action'][total_id+1])
            else:
                episode_id += 1
                ...
                point_cloud_arrays.append(deepcopy(point_cloud_arrays_sub))
                state_arrays.append(deepcopy(state_arrays_sub))
                action_arrays.append(deepcopy(action_arrays_sub))
                reward_arrays.append(deepcopy(reward_arrays_sub))
                done_arrays.append(deepcopy(done_arrays_sub))
                timeout_arrays.append(deepcopy(timeout_arrays_sub))
                next_img_arrays.append(deepcopy(next_img_arrays_sub))
                next_point_cloud_arrays.append(deepcopy(next_point_cloud_arrays_sub))
                next_state_arrays.append(deepcopy(next_state_arrays_sub))

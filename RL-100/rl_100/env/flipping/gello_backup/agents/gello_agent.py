...
PORT_CONFIG_MAP: Dict[str, DynamixelRobotConfig] = {
    ...
    #),
    # Single UR (left)
    #"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAX80TC-if00-port0": DynamixelRobotConfig(
    ...
    #),
    # Single UR (right)
    #"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAIP496-if00-port0": DynamixelRobotConfig(
    #    joint_ids=(1, 2, 3, 4, 5, 6),
    #    joint_offsets=(
    #        1*np.pi/2,
    #        3*np.pi/2,

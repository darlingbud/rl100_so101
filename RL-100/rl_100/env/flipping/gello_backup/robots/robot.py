...
class BimanualRobot(Robot):
    ...
    def command_cartesian_state(self, cartesian_state: np.ndarray) -> None:
        ...
        Args:
            cartesian_state (np.ndarray): [left_ee(7), right_ee(7)] = 14维
                每个臂: [x, y, z, rx, ry, rz, gripper]
        """
        # 左臂: 前 7 维
        self._robot_l.command_cartesian_state(cartesian_state[:7])
        # 右臂: 后 7 维
        self._robot_r.command_cartesian_state(cartesian_state[7:])

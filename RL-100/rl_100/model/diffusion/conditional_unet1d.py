...
from rl_100.model.diffusion.conv1d_components import (
    Downsample1d, Upsample1d, Conv1dBlock)
from rl_100.model.diffusion.positional_embedding import SinusoidalPosEmb
...
class ConditionalUnet1D(nn.Module):
    ...
    def forward(self, 
        ...
        for idx, (resnet, resnet2, upsample) in enumerate(self.up_modules):
            # print(f"x shape before cat: {x.shape}, h[-1] shape: {h[-1].shape}")

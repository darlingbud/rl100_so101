...
USE_ACTION_EMBED=${USE_ACTION_EMBED:-True}
Q_HIDDEN_DIM=${Q_HIDDEN_DIM:-512}
V_HIDDEN_DIM=${V_HIDDEN_DIM:-512}
DYNAMICS_HIDDEN_DIMS=${DYNAMICS_HIDDEN_DIMS:-"[400,400,400,400]"}
...
CRITIC_STRIDE=${CRITIC_STRIDE:-1}
FINETUNE_STRIDE=${FINETUNE_STRIDE:-16}

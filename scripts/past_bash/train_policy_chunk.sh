...
encoder_type='dp3vib'
model='dp3'
run_dir="data/outputs_chunk_as_single_action/${exp_name}_seed${seed}/${act}/${encoder_type}/${model}"
for lr in 1e-6 2e-6 1e-5
do
    for rollout_length in 3 10 5
    do
    for clip_std_max in 0.1
    do

...
# Examples:
# bash scripts/train_policy_online_cm_chunk_ddp_distill.sh rl100 adroit_door_medium 0112 100
# bash scripts/train_policy_online_cm_chunk_ddp_distill.sh rl100 adroit_door_medium 0112 100
# DISTILL_GPU_COUNT=4 bash scripts/train_policy_online_cm_chunk_ddp_distill.sh rl100 adroit_door_medium 0112 100 16
# DISTILL_GPUS=0,1,2,3 ONLINE_GPU=0 bash scripts/train_policy_online_cm_chunk_ddp_distill.sh rl100 adroit_door_medium 0112 100 16
...
stage1_run_dir="data/outputs_two_stage_chunk/${exp_name}_seed${seed}/${act}/${encoder_type}/${model}"

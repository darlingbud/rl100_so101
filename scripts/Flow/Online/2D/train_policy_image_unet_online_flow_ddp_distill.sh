...
# Examples:
# bash scripts/train_policy_image_unet_online_flow_ddp_distill.sh rl100 adroit_door_medium 0112 100
# bash scripts/train_policy_image_unet_online_flow_ddp_distill.sh rl100 adroit_door_medium 0112 100 8
# DISTILL_GPU_COUNT=4 bash scripts/train_policy_image_unet_online_flow_ddp_distill.sh rl100 adroit_door_medium 0112 100 8
# DISTILL_GPUS=0,1,2,3 ONLINE_GPU=0 bash scripts/train_policy_image_unet_online_flow_ddp_distill.sh rl100 adroit_door_medium 0112 100 8
...
stage1_run_dir="data/outputs_2d_flow_two_stage/${exp_name}_seed${seed}/${act}/${encoder_type}/${model}"

# Examples:
# bash scripts/train_policy_flow.sh rl100 adroit_door_medium 0112 100
# bash scripts/train_policy_flow.sh rl100 adroit_door_medium 0112 100
...
encoder_type='dp3vib'
model='skipnet'
run_dir="data/outputs_flow/${exp_name}_seed${seed}/${act}/${encoder_type}/${model}"
    ...
    do
        ...
        do
            python train.py --config-name=${config_name}.yaml \
                                    ...
                                    dynamics.dynamics_max_epochs=250 \
                                    distill_phase=null \
                                    unio4.bppo_lr=${lr} \
                                    unio4.bppo_steps=5000 \
